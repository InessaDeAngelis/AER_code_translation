// Code for model comparisons in Appendix C. This is the benchmark model 
// (i.e., the code is identical to Dyn_RIR_commented.mod).
...
save('irfs_RIR.mat', 'Rn_bench', 'Pi_bench', 'Y_bench', 'C_bench', 'Invest_bench', 'L_bench')
