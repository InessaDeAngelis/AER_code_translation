// Version of the main dynare file to produce left panel of Figure 7 
// (marginal response of NII to interest rate shocks). Only difference
// from Dyn_RIR_commented.mod is in the "shocks" block (saved variables +
// shocks imported from 'shocks_RIR_nii.mat') 
...
// IMPACT EFFECT FOR VARIOUS INITIAL INTEREST RATES
load('shocks_RIR_nii.mat')
