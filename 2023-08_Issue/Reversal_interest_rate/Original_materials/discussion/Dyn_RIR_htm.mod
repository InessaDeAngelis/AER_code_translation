// Extension of the model with "held-to-maturity" bonds
// Variable S_H governs initial quantity of held-to-maturity bonds
// Except for evolution of S_H + capital gains equation, rest of the file 
// is identical to main dynare file Dyn_RIR_commented.mod

var llambda R dRL rk_nbd rk_bd w EA_k L L_nbd L_bd K_nbd K_bd Y Y_bd Y_nbd C Invest Invest_nbdx Invest_bdx  Invest_nbd Invest_bd Q_nbd Q_bd nu_A nu_mp nu_fg Rn Pi P_I D RDn RLn Pi_D Pi_L LevCost Lo Eq_B CG S Q_S RS NII_B RL Divs ROE_annual bbeta_endog nu_bbeta LR_rate Rn_target Trule S_H;
varexo eps_A eps_mp eps_fg eps_bbeta eps_target eps_Trule S_H_init;
...
S_H = S_H_init + (1-1/tau_S)/Pi*S_H(-1);
...
load('shock_value_htm.mat', 'var_epsV', 'var_SH')
