// Dynare file to produce forward guidance IRFs. Identical to main dynare
// file Dyn_RIR_commented.mod except for shocks block (use forward guidance
// shocks instead of standard monetary shocks)

var llambda R dRL rk_nbd rk_bd w EA_k L L_nbd L_bd K_nbd K_bd Y Y_bd Y_nbd C Invest Invest_nbdx Invest_bdx  Invest_nbd Invest_bd Q_nbd Q_bd nu_A nu_mp nu_fg Rn Pi P_I D RDn RLn Pi_D Pi_L Lo Eq_B CG S Q_S RS NII_B RL Divs ROE_annual bbeta_endog nu_bbeta LR_rate Rn_target Trule;
...
S = Eq_B + D - Lo;
NII_B = Pi_L + Pi_D + (Rn/Pi(+1)-1)*Eq_B - Eq_B*1/3*kappa_L*max(0, Lo/Eq_B-1/rho_SS)^3;
CG = (RS - R(-1))*S(-1);
...
Lo_3_10g = Lo_3;
Lo_7_10g = Lo_7;
Invest_3_10g = Invest_3;
Invest_7_10g = Invest_7;
Y_3_10g = Y_3;
Y_7_10g = Y_7;
Pi_3_10g = Pi_3;
Pi_7_10g = Pi_7;
