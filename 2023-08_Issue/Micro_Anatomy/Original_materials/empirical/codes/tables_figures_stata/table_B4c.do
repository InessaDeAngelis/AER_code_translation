...
* Code replicates Table B4 - panel c
**********************************************************************
 ...
 *********************************************************
 **** Table B4 panel - Including Durable Consumption *****
 *********************************************************
...
replace income = y - yl2 - yca2
replace consum = c - yca2  - yl2
...
outsheet tc* in 1/`row' using "$output/tableB4_c.tex", noquote nonames delimit(" ") replace
