...
* Code replicates Table B4 - panel b
**********************************************************************
 ...
 ***********************************************************************
 **** Table B4 panel - Total Monetary Income, Baseline Consumption *****
 ***********************************************************************
...
outsheet tc* in 1/`row' using "$output/tableB4_b.tex", noquote nonames delimit(" ") replace
