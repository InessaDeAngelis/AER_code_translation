...
* Code replicates Table 1 panel (a) and Table B.8 panels (a) and (b)
* Calculates observations for baseline exercises
**********************************************************************
...
outsheet tc* in 1/`row' using "$output/table1_a.tex", noquote nonames delimit(" ") replace
...
outsheet tc* in 1/`row' using "$output/tableB8_a.tex", noquote nonames delimit(" ") replace
...
outsheet tc* in 1/`row' using "$output/tableB8_b.tex", noquote nonames delimit(" ") replace

*** Table - baseline number of observations
...
outsheet tc* in 1/`row' using "$output/table_baselineN.tex", noquote nonames delimit(" ") replace
