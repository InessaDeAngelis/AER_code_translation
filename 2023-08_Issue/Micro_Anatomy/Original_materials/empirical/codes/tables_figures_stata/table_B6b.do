...
* Code replicates Table B6 panel b
* elasticities across wealth levels top income households
**********************************************************************
...
outsheet tc* in 1/`row' using "$output/tableB6_c.tex", noquote nonames delimit(" ") replace
...
outsheet tc* in 1/`row' using "$output/tableB6_d.tex", noquote nonames delimit(" ") replace
