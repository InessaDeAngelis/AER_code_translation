...
* Code replicates Table 1 panel b and Table B7 panel b
* Elasticities by home ownership
**********************************************************************
...
outsheet tc* in 1/`row' using "$output/table2_b.tex", noquote nonames delimit(" ") replace
