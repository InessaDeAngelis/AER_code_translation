...
* Code replicates Table B3 - panel b
**********************************************************************
 ...
 **********************************************
 ******* Table B3 panel - Non-Residualized ****
 **********************************************
...
reg ly year_t year [aw=factor07_]
predict uy if e(sample),res

reg lc year_t year [aw=factor07_]
...
outsheet tc* in 1/`row' using "$output/tableB3_b.tex", noquote nonames delimit(" ") replace
