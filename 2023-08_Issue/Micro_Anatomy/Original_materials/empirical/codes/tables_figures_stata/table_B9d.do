...
* Code replicates Table B9 panel d
* elasticities of non luxury goods consumption
**********************************************************************
...
outsheet tc* in 1/`row' using "$output/tableB9_e.tex", noquote nonames delimit(" ") replace
