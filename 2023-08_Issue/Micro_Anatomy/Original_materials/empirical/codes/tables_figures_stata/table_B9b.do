...
* elasticities of non tradable goods consumption
**********************************************************************
...
*** TABLE B9 - Non-Tradable Consumption
...
outsheet tc* in 1/`row' using "$output/tableB9_c.tex", noquote nonames delimit(" ") replace
