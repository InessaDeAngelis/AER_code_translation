...
par.lr_mat = zeros(40,1); % r process
par.lr_mat(1) = par.r_star_l;
par.lr_mat(2:5) = par.r_star_l+0.045;
par.lr_mat(6:end) = par.r_star_l;
...
[c_PI,ap_PI,y_PI,a_PI] = policy_shock_r_nonh_asym(par,Grid,s,s_a,s_mu,n_a,n_mu,length(s),maxiter,tol);
Y_mat_PI = par.Y_mat;
