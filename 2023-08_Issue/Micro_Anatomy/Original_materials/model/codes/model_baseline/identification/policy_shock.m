...
if T == 1 
    ...
    a_grid = s_a;
       ...
       [c_policy_aux,~,~,~] = solutionEGM(par,Grid,Grid.s,agrid,mugrid,length(agrid),length(mugrid),length(Grid.s),maxiter,tol);
       ...
       idB = (c_policy(:,2)<=10e-07);
       c_policy(idB,2) = 10e-07; % minimum consumption
