function [c_policy, a_policy,y_grid,a_grid] = policy_shock_r(par,Grid,s,s_a,s_mu,n_a,n_mu,N,maxiter,tol)

% length of shock
T = length(par.r_mat) - 1;
