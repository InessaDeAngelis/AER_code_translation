...
//OLS estimates used for initial values
	...
	Z_main=st_data(., ("const" ,"l_lag", "k" , "k_lag"   , "p",  "p_lag",  "uw" , "uw_lag"  ))
...
{
	external PHI,PHI_lag,Z_main,X_main,X_main_lag,X,X_lag,Z,Y,C	, CONSOL
	...
	OMEGA_lag_pool = (C, OMEGA_lag,CONSOL)
