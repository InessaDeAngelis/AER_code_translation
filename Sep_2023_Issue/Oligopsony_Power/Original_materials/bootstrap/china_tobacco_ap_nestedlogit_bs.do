...
global share = 0.117647  //0.235294 	 
...
ivregress 2sls lhs_dq`m' (pm   lqshare_nest_dq`m'  =  nf_dq6 av_mintemp_dq4_ot av_mintemp_dq2_ot  av_maxtemp_dq4_ot  av_maxtemp_dq2_ot av_rain_dq4_ot  av_rain_dq2_ot ///
  tfp_bb_ot_dq6  tfp_bb    ) lrain  luw dexp pctexp  mintemp  maxtemp  yr   lp  dhs1 dhs2 dtype1 dtype2 i.dq2id   
...
tfp_bb  tfp_bb_ot_dq6     )  lrain luw dexp pctexp   mintemp  maxtemp  yr   lp  dhs* dtype1 dtype2 i.dq2id 
...
egen `var'_p01 = pctile(`var'),p(02)
egen `var'_p99 = pctile(`var'),p(98)
}
 
foreach mod in    "nl" "tris" {
foreach var in   "mu" "md"  {
forvalues m = 6(2)6 {
replace `var'_`mod'_dq`m' = . if `var'_`mod'_dq`m' < `var'_`mod'_dq`m'_p01 | `var'_`mod'_dq`m' > `var'_`mod'_dq`m'_p99	
drop `var'_`mod'_dq`m'_p01 `var'_`mod'_dq`m'_p99
}
}
}
 */
