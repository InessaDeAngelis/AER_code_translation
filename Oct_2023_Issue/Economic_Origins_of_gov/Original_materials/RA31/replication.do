...
space_reg Y X cutoff1 cutoff2 lugal_indicator_ratio period_lag_2_tr period_tr_t, ///
 xreg(2) coord(2) model(reghdfe, $baseline_FE) 
mat se = e(se)
scalar c_se = se[2, 1]

reghdfe lugal_indicator_ratio $add_treatment, ///
 cluster($cluster_level) absorb($baseline_FE)
$add_y
$add_p_value 
$rec_est

space_reg Y X cutoff1 cutoff2 gal_indicator_ratio period_lag_2_tr period_tr_t, ///
 xreg(2) coord(2) model(reghdfe, $baseline_FE) 
mat se = e(se)
scalar c_se = se[2, 1]

reghdfe gal_indicator_ratio $add_treatment, ///
 cluster($cluster_level) absorb($baseline_FE)
$add_y
$add_p_value 
$rec_est

space_reg Y X cutoff1 cutoff2 canal_indicator_ratio period_lag_2_tr period_tr_t, ///
 xreg(2) coord(2) model(reghdfe, $baseline_FE) 
mat se = e(se)
scalar c_se = se[2, 1]

reghdfe canal_indicator_ratio $add_treatment, ///
 cluster($cluster_level) absorb($baseline_FE)
$add_y
$add_p_value 
$rec_est

space_reg Y X cutoff1 cutoff2 tax_indicator_ratio period_lag_2_tr period_tr_t, ///
 xreg(2) coord(2) model(reghdfe, $baseline_FE) 
mat se = e(se)
scalar c_se = se[2, 1]

reghdfe tax_indicator_ratio $add_treatment, ///
 cluster($cluster_level) absorb($baseline_FE)
$add_y
$add_p_value 
$rec_est

esttab  using "$project_output_path\RA31.tex", ///
b(2) se(2) se ///
