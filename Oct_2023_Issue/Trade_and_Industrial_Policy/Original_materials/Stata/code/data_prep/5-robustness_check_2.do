...
outreg using output/temp/FigP1_B_outreg.tex, varlabels tex fragment replace  
...
outreg using output/temp/FigP1_B_outreg.tex, varlabels tex fragment merge  
...
save data/internally_generated/figP1_exc_rate_control.dta, replace ;
