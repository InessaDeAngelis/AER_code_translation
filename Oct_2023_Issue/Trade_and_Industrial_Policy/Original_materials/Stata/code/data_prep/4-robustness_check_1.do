...
/******************************************************************************
foreach var of varlist VATPercent TariffPercent exc_col_F* exc_usd_F* {
replace `var' = `var' * CustomsValueTariffBase
}

collapse (sum) CustomsValueTariffBase Valuetobepay Quantity VATPercent ///
TariffPercent exc_col_F* exc_usd_F*, by(year ProductHS CountryofOrigin Provider)
...
outreg using output/temp/FigP1_A_outreg.tex, varlabels tex fragment replace  
...
outreg using output/temp/FigP1_A_outreg.tex, varlabels tex fragment merge  
...
save data/internally_generated/figP1_initial_share_iv.dta, replace;
